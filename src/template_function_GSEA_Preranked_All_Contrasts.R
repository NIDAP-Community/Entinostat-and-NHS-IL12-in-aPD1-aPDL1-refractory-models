GSEA_Preranked_All_Contrasts <- function(DEG_COMBO_PBS, msigdb_v6_2_with_orthologs) {
...
## GSEA
collections_to_include = c("H: hallmark gene sets","CP:KEGG: KEGG gene sets","C7: immunologic signatures","C5: GO gene sets") # object Pathway/Collection lookup
...
#image: png
png(filename="GSEA_Preranked_All_Contrasts.png", width=image_width, height=image_height, units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_function_GSEA_Preranked_All_Contrasts.R #########################################################################")
...
var_GSEA_Preranked_All_Contrasts<-GSEA_Preranked_All_Contrasts(var_DEG_COMBO_PBS,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Preranked_All_Contrasts,"var_GSEA_Preranked_All_Contrasts.rds")
