Volcano_ENT_PBS <- function(DEG_ENT_PBS) {
    # image: png
...
print("template_function_Volcano_ENT_PBS.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_ENT_PBS<-readRDS("var_DEG_ENT_PBS.rds")
invisible(graphics.off())
var_Volcano_ENT_PBS<-Volcano_ENT_PBS(var_DEG_ENT_PBS)
invisible(graphics.off())
saveRDS(var_Volcano_ENT_PBS,"var_Volcano_ENT_PBS.rds")
