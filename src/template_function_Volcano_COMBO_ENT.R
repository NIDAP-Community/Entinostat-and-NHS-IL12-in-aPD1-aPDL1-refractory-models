Volcano_COMBO_ENT <- function(DEG_COMBO_ENT) {
    # image: png
...
print("template_function_Volcano_COMBO_ENT.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_COMBO_ENT<-readRDS("var_DEG_COMBO_ENT.rds")
invisible(graphics.off())
var_Volcano_COMBO_ENT<-Volcano_COMBO_ENT(var_DEG_COMBO_ENT)
invisible(graphics.off())
saveRDS(var_Volcano_COMBO_ENT,"var_Volcano_COMBO_ENT.rds")
