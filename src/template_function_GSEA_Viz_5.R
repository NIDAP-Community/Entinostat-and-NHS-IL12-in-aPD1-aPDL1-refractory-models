GSEA_Viz_5 <- function(DEG_COMBO_PBS, GSEA_Filter_All_Contrasts, normalized_counts, ccbr1144_Metadata, msigdb_v6_2_with_orthologs) {
...
## PARAMETERS
    ...
    plot_limit = "ALL"
    topline = 'coordinate'
    pathways = c("KEGG_CYTOKINE_CYTOKINE_RECEPTOR_INTERACTION")
    geneid = "Gene"
    geneid_gex = "Gene"
    contrasts = c()
    species = "Mouse"
    ...
    gsea_df <- GSEA_Filter_All_Contrasts
...
png(filename="GSEA_Viz_5.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_GSEA_Viz_5.R #########################################################################")
...
var_GSEA_Viz_5<-GSEA_Viz_5(var_DEG_COMBO_PBS,var_GSEA_Filter_All_Contrasts,var_normalized_counts,var_ccbr1144_Metadata,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Viz_5,"var_GSEA_Viz_5.rds")
