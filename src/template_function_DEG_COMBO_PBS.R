DEG_COMBO_PBS <- function(filtered_counts_1, ccbr1144_Metadata) {
...
print("template_function_DEG_COMBO_PBS.R #########################################################################")
...
var_DEG_COMBO_PBS<-DEG_COMBO_PBS(var_filtered_counts_1,var_ccbr1144_Metadata)
invisible(graphics.off())
saveRDS(var_DEG_COMBO_PBS,"var_DEG_COMBO_PBS.rds")
