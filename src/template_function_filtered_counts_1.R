filtered_counts_1 <- function(counts_matrix, ccbr1144_Metadata) {
   imageType = "png"
  spark.df = counts_matrix
    samples_to_include = c("S1_1","S1_2","S1_3","S2_1","S2_2","S2_3","S3_1","S3_2","S3_3","S4_1","S4_2","S4_4","S4_6")
    gene_col="gene_name"
    sample_col="Sample"
    metadata <- ccbr1144_Metadata
    group_col<- "Group"
    plot_labels_col<-"Label"
...
var_counts_matrix<-readRDS("var_counts_matrix.rds")
var_ccbr1144_Metadata<-readRDS("var_ccbr1144_Metadata.rds")
invisible(graphics.off())
var_filtered_counts_1<-filtered_counts_1(var_counts_matrix,var_ccbr1144_Metadata)
invisible(graphics.off())
saveRDS(var_filtered_counts_1,"var_filtered_counts_1.rds")
