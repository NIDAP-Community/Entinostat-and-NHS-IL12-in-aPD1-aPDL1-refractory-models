Volcano_All_Contrasts <- function(DEG_All_Contrasts) {
    # image: png
   ...
   stattype<-"pval"
    ...
    if (FALSE & (("png" =='svg')))  {
        library(svglite)
        svglite::svglite(
        file="Volcano_All_Contrasts.png",
        width=15,
        height=15,
        pointsize=1,
        bg="white",
...
print("template_function_Volcano_All_Contrasts.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_All_Contrasts<-readRDS("var_DEG_All_Contrasts.rds")
invisible(graphics.off())
var_Volcano_All_Contrasts<-Volcano_All_Contrasts(var_DEG_All_Contrasts)
invisible(graphics.off())
saveRDS(var_Volcano_All_Contrasts,"var_Volcano_All_Contrasts.rds")
