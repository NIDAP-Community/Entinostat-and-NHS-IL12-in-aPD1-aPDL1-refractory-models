DEG_COMBO_ENT <- function(filtered_counts_1, ccbr1144_Metadata) {
...
print("template_function_DEG_COMBO_ENT.R #########################################################################")
...
var_DEG_COMBO_ENT<-DEG_COMBO_ENT(var_filtered_counts_1,var_ccbr1144_Metadata)
invisible(graphics.off())
saveRDS(var_DEG_COMBO_ENT,"var_DEG_COMBO_ENT.rds")
