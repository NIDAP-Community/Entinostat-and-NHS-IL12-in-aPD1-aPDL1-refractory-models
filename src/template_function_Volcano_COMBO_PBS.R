Volcano_COMBO_PBS <- function(DEG_COMBO_PBS) {
    # image: png
...
print("template_function_Volcano_COMBO_PBS.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_COMBO_PBS<-readRDS("var_DEG_COMBO_PBS.rds")
invisible(graphics.off())
var_Volcano_COMBO_PBS<-Volcano_COMBO_PBS(var_DEG_COMBO_PBS)
invisible(graphics.off())
saveRDS(var_Volcano_COMBO_PBS,"var_Volcano_COMBO_PBS.rds")
