Volcano_NHS_PBS <- function(DEG_NHS_PBS) {
    # image: png
...
print("template_function_Volcano_NHS_PBS.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_NHS_PBS<-readRDS("var_DEG_NHS_PBS.rds")
invisible(graphics.off())
var_Volcano_NHS_PBS<-Volcano_NHS_PBS(var_DEG_NHS_PBS)
invisible(graphics.off())
saveRDS(var_Volcano_NHS_PBS,"var_Volcano_NHS_PBS.rds")
