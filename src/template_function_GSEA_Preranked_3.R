GSEA_Preranked_3 <- function(DEG_ENT_PBS, msigdb_v6_2_with_orthologs) {
...
## GSEA
collections_to_include = c("C5: GO gene sets","CP:KEGG: KEGG gene sets") # object Pathway/Collection lookup
...
#image: png
png(filename="GSEA_Preranked_3.png", width=image_width, height=image_height, units="px", pointsize=4, bg="white", res=image_resolution, type="cairo") 
...
print("template_function_GSEA_Preranked_3.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_DEG_ENT_PBS<-readRDS("var_DEG_ENT_PBS.rds")
var_msigdb_v6_2_with_orthologs<-readRDS("var_msigdb_v6_2_with_orthologs.rds")
invisible(graphics.off())
var_GSEA_Preranked_3<-GSEA_Preranked_3(var_DEG_ENT_PBS,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Preranked_3,"var_GSEA_Preranked_3.rds")
