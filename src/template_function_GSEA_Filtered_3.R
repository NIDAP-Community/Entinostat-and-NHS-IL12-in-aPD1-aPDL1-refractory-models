GSEA_Filtered_3 <- function(GSEA_Preranked_3, msigdb_v6_2_with_orthologs ) {
...
print("template_function_GSEA_Filtered_3.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_GSEA_Preranked_3<-readRDS("var_GSEA_Preranked_3.rds")
var_msigdb_v6_2_with_orthologs<-readRDS("var_msigdb_v6_2_with_orthologs.rds")
invisible(graphics.off())
var_GSEA_Filtered_3<-GSEA_Filtered_3(var_GSEA_Preranked_3,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Filtered_3,"var_GSEA_Filtered_3.rds")
