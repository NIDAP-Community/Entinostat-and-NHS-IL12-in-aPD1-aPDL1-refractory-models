Supp_Fig_5A_Part2 <- function(GSEA_Filtered_1) {
    # image: png
    ...
    goResults <- dplyr::collect(GSEA_Filtered_1)
    if(FALSE){
...
print("template_function_Supp_Fig_5A_Part2.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
var_GSEA_Filtered_1<-readRDS("var_GSEA_Filtered_1.rds")
invisible(graphics.off())
var_Supp_Fig_5A_Part2<-Supp_Fig_5A_Part2(var_GSEA_Filtered_1)
invisible(graphics.off())
saveRDS(var_Supp_Fig_5A_Part2,"var_Supp_Fig_5A_Part2.rds")
