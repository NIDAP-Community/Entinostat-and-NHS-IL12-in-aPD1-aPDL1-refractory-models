DEG_All_Contrasts <- function(filtered_counts_1, ccbr1144_Metadata) {
    ...
    contrasts_param<-c("COMBO-PBS","COMBO-ENT","COMBO-NHS","NHS-PBS","ENT-PBS")
...
print("template_function_DEG_All_Contrasts.R #########################################################################")
...
var_DEG_All_Contrasts<-DEG_All_Contrasts(var_filtered_counts_1,var_ccbr1144_Metadata)
invisible(graphics.off())
saveRDS(var_DEG_All_Contrasts,"var_DEG_All_Contrasts.rds")
