DEG_ENT_PBS <- function(filtered_counts_1, ccbr1144_Metadata) {
...
print("template_function_DEG_ENT_PBS.R #########################################################################")
...
var_DEG_ENT_PBS<-DEG_ENT_PBS(var_filtered_counts_1,var_ccbr1144_Metadata)
invisible(graphics.off())
saveRDS(var_DEG_ENT_PBS,"var_DEG_ENT_PBS.rds")
